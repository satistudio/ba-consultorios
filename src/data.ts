...
export const BRAND_INFO = {
  ...
  facebookUrl: "https://www.facebook.com/share/1BXQLX6wB7/",
  instagramHandle: "@baconsultoriosmedicos",
  address: "Almafuerte 3558, San Justo, La Matanza",
  phone: "3970-1945",
  whatsapp: "+54 9 11 6434-4822",
  whatsappUrl: "https://wa.me/5491164344822?text=Hola!%20Quiero%20pedir%20un%20turno%20en%20BA%20Consultorios%20M%C3%A9dicos.%20(Vengo%20de%20la%20web)",
...
// Estudios que BA deriva a centros de diagnóstico de confianza con aranceles
// preferenciales. Solo nombres — los aranceles cambian mensualmente y se
// informan por WhatsApp. Fuente: listado KORPER (abril 2026).
export const DERIVED_STUDIES: { category: string; name: string }[] = [
  { category: "Densitometría", name: "Densitometría ósea (una región)" },
  { category: "Densitometría", name: "Densitometría ósea (dos regiones)" },
  { category: "Densitometría", name: "Densitometría ósea (tres regiones)" },
  { category: "Densitometría", name: "Densitometría ósea corporal total" },
  { category: "Neurofisiología", name: "Electromiograma facial" },
  { category: "Neurofisiología", name: "Electromiograma facial con velocidad de conducción" },
  { category: "Neurofisiología", name: "Electromiograma miembros inferiores" },
  { category: "Neurofisiología", name: "Electromiograma miembros inferiores con velocidad de conducción" },
  { category: "Neurofisiología", name: "Electromiograma miembros superiores" },
  { category: "Neurofisiología", name: "Electromiograma miembros superiores con velocidad de conducción" },
  { category: "Neurofisiología", name: "Electromiograma 4 miembros" },
  { category: "Neurofisiología", name: "Electromiograma 4 miembros con velocidad de conducción" },
  { category: "Neurofisiología", name: "Estimulación repetitiva" },
  { category: "Neurofisiología", name: "Órbita con estimulación repetitiva" },
  { category: "Potenciales evocados", name: "Potenciales evocados auditivos con umbrales" },
  { category: "Potenciales evocados", name: "Potenciales evocados auditivos de tronco" },
  { category: "Potenciales evocados", name: "Potenciales evocados auditivos multifuncional" },
  { category: "Potenciales evocados", name: "Potenciales evocados somatosensitivos" },
  { category: "Potenciales evocados", name: "Potenciales evocados somatosensitivos 4 miembros" },
  { category: "Potenciales evocados", name: "Potenciales evocados visuales" },
  { category: "Polisomnografía", name: "Polisomnografía 20 canales (adultos)" },
  { category: "Polisomnografía", name: "Polisomnografía 20 canales (neopediátrica)" },
  { category: "Polisomnografía", name: "Polisomnografía con oximetría (adultos)" },
  { category: "Polisomnografía", name: "Polisomnografía con oximetría (neopediátrica)" },
  { category: "Polisomnografía", name: "Polisomnografía con oximetría y CPAP (adultos)" },
  { category: "Polisomnografía", name: "Poligrafía respiratoria (adultos)" },
  { category: "Polisomnografía", name: "CPAP (adultos)" },
  { category: "Mamografía", name: "Mamografía bilateral magnificada" },
  { category: "Mamografía", name: "Mamografía unilateral magnificada" },
  { category: "Resonancia", name: "Angiorresonancia de cerebro" },
  { category: "Resonancia", name: "Angiorresonancia de cuello" },
  { category: "Resonancia", name: "Colangiorresonancia" },
  { category: "Resonancia", name: "Urorresonancia" },
  { category: "Resonancia", name: "RMN de abdomen" },
  { category: "Resonancia", name: "RMN de ambas órbitas" },
  { category: "Resonancia", name: "RMN de antebrazo" },
  { category: "Resonancia", name: "RMN de articulación temporomaxilar (ATM)" },
  { category: "Resonancia", name: "RMN de brazo" },
  { category: "Resonancia", name: "RMN de cadera" },
  { category: "Resonancia", name: "RMN de conducto auditivo interno (CAI)" },
  { category: "Resonancia", name: "RMN de cerebro" },
  { category: "Resonancia", name: "RMN de cintura escapular" },
  { category: "Resonancia", name: "RMN de clavícula" },
  { category: "Resonancia", name: "RMN de codo" },
  { category: "Resonancia", name: "RMN de columna cervical" },
  { category: "Resonancia", name: "RMN de columna dorsal" },
  { category: "Resonancia", name: "RMN de columna lumbar" },
  { category: "Resonancia", name: "RMN de columna lumbosacra" },
  { category: "Resonancia", name: "RMN de columna torácica" },
  { category: "Resonancia", name: "RMN de cuello" },
  { category: "Resonancia", name: "RMN de glúteo" },
  { category: "Resonancia", name: "RMN de hipófisis" },
  { category: "Resonancia", name: "RMN de hombro" },
  { category: "Resonancia", name: "RMN de macizo craneofacial" },
  { category: "Resonancia", name: "RMN de mano" },
  { category: "Resonancia", name: "RMN de muñeca" },
  { category: "Resonancia", name: "RMN de muslo" },
  { category: "Resonancia", name: "RMN de órbitas con cerebro" },
  { category: "Resonancia", name: "RMN de pelvis" },
  { category: "Resonancia", name: "RMN de pie" },
  { category: "Resonancia", name: "RMN de pierna" },
  { category: "Resonancia", name: "RMN de rodilla" },
  { category: "Resonancia", name: "RMN de sacro-cóxis" },
  { category: "Resonancia", name: "RMN de tobillo" },
  { category: "Resonancia", name: "RMN de tórax" },
  { category: "Resonancia", name: "RMN de otras regiones" },
  { category: "Tomografía", name: "Urotomografía" },
  { category: "Tomografía", name: "TC de abdomen" },
  { category: "Tomografía", name: "TC de antebrazo" },
  { category: "Tomografía", name: "TC de articulación temporomaxilar (ATM)" },
  { category: "Tomografía", name: "TC de brazo" },
  { category: "Tomografía", name: "TC de cadera" },
  { category: "Tomografía", name: "TC cerebral" },
  { category: "Tomografía", name: "TC de codo" },
  { category: "Tomografía", name: "TC de columna cervical" },
  { category: "Tomografía", name: "TC de columna dorsal" },
  { category: "Tomografía", name: "TC de columna lumbosacra" },
  { category: "Tomografía", name: "TC de cuello" },
  { category: "Tomografía", name: "TC ginecológica" },
  { category: "Tomografía", name: "TC de hombro" },
  { category: "Tomografía", name: "TC de macizo craneofacial" },
  { category: "Tomografía", name: "TC de mano" },
  { category: "Tomografía", name: "TC de muñeca" },
  { category: "Tomografía", name: "TC de oído medio, mastoides y ático" },
  { category: "Tomografía", name: "TC de parrilla costal" },
  { category: "Tomografía", name: "TC de pelvis" },
  { category: "Tomografía", name: "TC de peñascos" },
  { category: "Tomografía", name: "TC de pie" },
  { category: "Tomografía", name: "TC de pierna" },
  { category: "Tomografía", name: "TC de rodilla" },
  { category: "Tomografía", name: "TC sacrocoxígea" },
  { category: "Tomografía", name: "TC de senos paranasales" },
  { category: "Tomografía", name: "TC de silla turca" },
  { category: "Tomografía", name: "TC de testículos" },
  { category: "Tomografía", name: "TC tiroidea" },
  { category: "Tomografía", name: "TC de tobillo" },
  { category: "Tomografía", name: "TC de tórax" },
  { category: "Tomografía", name: "TC de vejiga y próstata" },
  { category: "Tomografía", name: "TC de otras regiones u órganos" },
  { category: "Tomografía", name: "Bloqueo radicular (unilateral o bilateral)" },
  { category: "Neurofisiología", name: "Espinograma (frente y perfil)" }
];
